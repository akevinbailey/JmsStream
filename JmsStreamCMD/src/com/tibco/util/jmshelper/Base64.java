 ...
 *
 * com.tibco.util.jmshelper.Base64 is a way of encoding 8-bit characters using only ASCII printable
 * characters similar to UUENCODE.  UUENCODE includes a filename where BASE64 does not.
 * The spec is described in RFC 2045.  com.tibco.util.jmshelper.Base64 is a scheme where
 ...
 * about 1/3.  The "=" character is used to pad the end.  com.tibco.util.jmshelper.Base64 is used,
 * among other things, to encode the user:password string in an
 * Authorization: header for HTTP.  Don't confuse com.tibco.util.jmshelper.Base64 with
 ...
 *                                  now need com.tibco.util.jmshelper.Base64 object and instance methods.
 *                                  new mailing address.
...
public final class Base64
{
   ...
   /**
    * Encode an arbitrary array of bytes as com.tibco.util.jmshelper.Base64 printable ASCII.
   ...
   {
      // each group or partial group of 3 bytes becomes four chars covered quotient
   ...
   /**
    * decode a well-formed complete com.tibco.util.jmshelper.Base64 string back into an array of bytes.
    * It must have an even multiple of 4 data characters (not counting \n),
    * padded out with = as needed.
    */
   public static byte[] decode(String s) throws ArrayIndexOutOfBoundsException
   {
   ...
   /**
    * convert binary data to a character string.
    */
   public static String decodeToString(String base64, String charsetName) throws java.io.UnsupportedEncodingException, ArrayIndexOutOfBoundsException
   {
      String strChars = null;

      if (charsetName == null || charsetName.equals("")) charsetName = "ISO8859_1";
      strChars = new String(decode(base64), charsetName);
      return strChars;
   }
...
} // end com.tibco.util.jmshelper.Base64
